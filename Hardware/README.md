...
- `1308#0_HB_1308_Task_4a/` contains Task 4A ESP32, perception, controller, metadata, and result files.
- `Multi_bot_controller.py/Multi_bot_controller/` contains multi-bot controller, perception, MQTT simulation controller, and packaging artifacts.
- `Multi_bot_stacking_controller/` contains the multi-bot stacking controller, feedback script, final plot, summary, and encrypted results.
